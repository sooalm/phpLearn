...
if( trim($username) == "")
{
  ...
  $destination_dir = getcwd().DIRECTORY_SEPARATOR . "usersImages\\";//$destiation_dir = "\usersImages";
  ...
  switch($_POST['sex'] )           //пол пользователя
  {
    ...
    $langString;                   // чекбоксы языков в 1 строке
...
<div class=" col-lg-8 col-md-8 ">
    ...
    <table class="table table-th-block">
      <tbody>
       ...
       <tr><td class="active">Пароль (md5):</td><td><?php echo md5($password) ?></td></tr>
